...
if __name__ == "__main__":
    ...
    if transport in ["sse", "streamable-http"]:
        ...
        print(f"\n📝 Configure MCP clients with per-developer credentials:")
        print(f'   See .vscode/mcp-http.json for example configuration')
        print(f'\n   Example client configuration:')
        print(f'   {{')
        print(f'     "inputs": [')
        print(f'       {{')
        print(f'         "type": "promptString",')
        print(f'         "id": "DOC_EMAIL",')
        print(f'         "description": "Your email for documentation access"')
        print(f'       }},')
        print(f'       {{')
        print(f'         "type": "promptString",')
        print(f'         "id": "DOC_PASSWORD",')
        print(f'         "description": "Your password",')
        print(f'         "password": true')
        print(f'       }}')
        print(f'     ],')
        print(f'     "mcpServers": {{')
        print(f'       "weather-api-docs": {{')
        print(f'         "url": "http://localhost:8000",')
        print(f'         "env": {{')
        print(f'           "DOC_EMAIL": "${{input:DOC_EMAIL}}",')
        print(f'           "DOC_PASSWORD": "${{input:DOC_PASSWORD}}"')
        print(f'         }}')
        print(f'       }}')
        print(f'     }}')
        print(f'   }}')
        print(f"\n💡 Each developer will be prompted for their own credentials")
